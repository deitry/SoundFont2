...
namespace Kermalis.SoundFont2
{
	public sealed class PdtaListChunk : SF2ListChunk
	{
		...
		/// </summary>
		public BAGSubChunk<SF2PresetBagHeader> PBAGSubChunk { get; }
		...
		public GENSubChunk<SF2PresetGeneratorHeader> PGENSubChunk { get; }
		...
		public BAGSubChunk<SF2InstrumentBagHeader> IBAGSubChunk { get; }
		...
		public GENSubChunk<SF2InstrumentGeneratorHeader> IGENSubChunk { get; }
		...
		internal PdtaListChunk(SF2 inSf2) : base(inSf2, "pdta")
		{
			...
			PBAGSubChunk = new BAGSubChunk<SF2PresetBagHeader>(inSf2, true);
			PMODSubChunk = new MODSubChunk(inSf2, true);
			PGENSubChunk = new GENSubChunk<SF2PresetGeneratorHeader>(inSf2, true);
			INSTSubChunk = new INSTSubChunk(inSf2);
			IBAGSubChunk = new BAGSubChunk<SF2InstrumentBagHeader>(inSf2, false);
			IMODSubChunk = new MODSubChunk(inSf2, false);
			IGENSubChunk = new GENSubChunk<SF2InstrumentGeneratorHeader>(inSf2, false);
		...
		internal PdtaListChunk(SF2 inSf2, EndianBinaryReader reader) : base(inSf2, reader)
		{
			...
			PBAGSubChunk = new BAGSubChunk<SF2PresetBagHeader>(inSf2, reader);
			PMODSubChunk = new MODSubChunk(inSf2, reader);
			PGENSubChunk = new GENSubChunk<SF2PresetGeneratorHeader>(inSf2, reader);
			INSTSubChunk = new INSTSubChunk(inSf2, reader);
			IBAGSubChunk = new BAGSubChunk<SF2InstrumentBagHeader>(inSf2, reader);
			IMODSubChunk = new MODSubChunk(inSf2, reader);
			IGENSubChunk = new GENSubChunk<SF2InstrumentGeneratorHeader>(inSf2, reader);
